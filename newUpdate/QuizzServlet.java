...
public class QuizzController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Quiz quizz = JSONUtil.buildQuizFromJson(obj);
		boolean isQuizAdded = QuizManager.insertQuiz(quizz);
		JSONObject resObj = new JSONObject();
		if(isQuizAdded) {
			resObj = ResponseUtil.buildResponse(obj, "Quizz added succesfully");
		}
		else {
			resObj = ResponseUtil.buildResponse(obj, "Quizz failed to added");
		}
