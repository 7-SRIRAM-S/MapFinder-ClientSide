...
//	-------------------------------  Quizz  -------------------------
   ...
   public static final String INSERTQUIZE= "INSERT INTO quizzes (title, description, content_type, issuer_name) VALUES (?, ?, ?, ?)";

    public static final String INSERTQUESTION=  "INSERT INTO questions (quiz_id, question_text) VALUES (?, ?)";

    public static final String INSERTCHOCE= "INSERT INTO choices (question_id, choice_text, is_correct) VALUES (?, ?, ?)";
    
    public static final String SELECT_QUESTION="SELECT * FROM questions WHERE quiz_id = ?";
    
    public static final String SELECT_QUIZZ = "SELECT * FROM quizzes";
    
    public static final String SELECT_CHOICE = "SELECT * FROM choices WHERE question_id = ?";
